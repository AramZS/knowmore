...
class Know_More {
	...
	private function add_filters() {
		add_filter( 'the_content', array( $this, 'add_know_more_module' ) );
	}	
	...
	function add_know_more_module( $content ){
		...
		if ( $headline ) {
			...
			$html  = '<div id="know_more">';
			$html .= '<h4 class="know_more_kicker">Read next</h4>';
			$html .= '<h2 class="know_more_headline"><a href="' . $url . '">' . $headline . '</a></h2>';
			$html .= '</div>';
